    ...
    <div className="mx-auto mt-[60px] w-[80%] sm:w-full max-w-sm p-6 border rounded-lg shadow md:p-8 dark:bg-gray-900 dark:border-gray-700">
        <form className="space-y-6" action="#">
          ...
          <div className="flex flex-col justify-between items-center gap-[10px]">
            ...
            <button type="button" onClick={handleGoogleSignIn} className=" inline-flex w-full  items-center justify-center rounded-md text-white bg-black/50 hover:bg-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:bg-gray-800">
